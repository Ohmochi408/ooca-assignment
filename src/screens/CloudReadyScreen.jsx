...
export default function CloudReadyScreen({ cloud, mode = 'new', skies, backdrop, onDone, onDiscard, onCancel }) {
  ...
  const compact = summing || (hasSummary && summaryOpen); // make room for the open summary card
  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      <div className="relative h-full flex flex-col px-4 pt-8 pb-9 overflow-y-auto">
        ...
        {/* Pick your Sky */}
        <div style={riseDelay(160)} className="rise-in mt-auto pt-8">
